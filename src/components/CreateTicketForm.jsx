...
const CreateTicketForm = ({ onSuccess }) => {
  ...
  return (
    <form
      ...
      className="max-w-xl bg-white rounded-2xl border border-gray-100 p-6 space-y-6"
    >
      {/* Header */}
      ...
      <div className="space-y-1">
        ...
        <textarea
          rows={4}
          className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm resize-none
                     focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500
                     transition"
